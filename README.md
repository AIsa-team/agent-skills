...
This PR expands the catalog to 25 deduplicated top-level skills after removing functional aliases and same-capability repackages. The merge analysis is in [SKILL_DEDUP_ANALYSIS.md](./SKILL_DEDUP_ANALYSIS.md).
